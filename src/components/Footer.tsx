        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold text-white">ŞarjFiyat</h2>
            </div>
            <p className="text-gray-400">
              Türkiye'deki elektrikli araç şarj operatörlerinin fiyatlarını 
              karşılaştırmanıza yardımcı olan bağımsız bir platformdur.
            </p>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@sarjfiyat.com" className="text-gray-400 hover:text-white">
                  info@sarjfiyat.com
                </a>
              </li>
              <li className="flex items-center">
