        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <span className="text-[#12B6B6] text-2xl font-bold" aria-hidden="true">[⚡]</span>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://facebook.com/sarjfiyat" 
                target="_blank"
              ...
              <a 
                href="https://twitter.com/sarjfiyat" 
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="https://instagram.com/sarjfiyat" 
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-3 text-[#12B6B6]" aria-hidden="true" />
                <a href="mailto:info@sarjfiyat.com" className="text-gray-400 hover:text-white transition-colors">
                  info@sarjfiyat.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-3 text-[#12B6B6]" aria-hidden="true" />
