      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
            Türkiye genelindeki elektrikli araç şarj istasyonlarının konumlarını harita üzerinde görüntüleyin.
          </p>
        </div>
        
        <Card className="border-0 rounded-xl overflow-hidden shadow-lg">
          <div className="h-[400px] sm:h-[500px] md:h-[600px] lg:h-[710px] xl:h-[810px] w-full">
            <iframe 
